...
OtterEngine::Object::Object(std::size_t id) : _velocity(0, 0), _id(id), _isPlayer(false)
{
	_name = "::";
...
void OtterEngine::Object::setIsPlayer(bool is) {
	_isPlayer = is;
}

bool OtterEngine::Object::getIsPlayer(void) {
	return _isPlayer;
}


void OtterEngine::Object::setName(std::string str) {
	_name = str;
}
