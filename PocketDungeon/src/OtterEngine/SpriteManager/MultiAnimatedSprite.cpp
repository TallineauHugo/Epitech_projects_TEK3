...
bool OtterEngine::MultiAnimatedSprite::loadSpriteFromFile(std::string filename)
{
	
}
	
bool OtterEngine::MultiAnimatedSprite::loadSpriteFromFile(std::string filename, sf::IntRect area)
{

}

bool OtterEngine::MultiAnimatedSprite::loadSpriteFromFile(std::string filename, int rowRange, int rowMax, int line, int lineMax)
{

}

sf::Vector2i OtterEngine::MultiAnimatedSprite::getPosition() const
{
}
